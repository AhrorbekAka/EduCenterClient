...
export default function Groups() {
    ...
    return (
        <Layout loading={loading}>
                    ...
                    <Row><Col className='p-0' md='12'>
                        <div className=" accordion my-3" id="accordionCollapse">
                            {groupList.length>0?groupList.map((group, index) =>
                                ...
                                </Card>):<h4 className='text-warning text-center'>Sizga guruh biriktirilmagan. Sayt egasiga murojat qiling</h4>}
                        </div>
                    </Col>
                    </Row>
                </Container>
            ...
            {studentModal===true&&<StudentModal isOpen={studentModal} groupId={selectedGroupId} toggleModal={setStudentModal} requestGroupList={requestGroupList} />}
